...
public class OtpVerification {
	...
	public void generateOneTimePassword(User users, String oTP) throws UnsupportedEncodingException, MessagingException {
	...
	private void sendOTPEmail(User users, String oTP) throws UnsupportedEncodingException, MessagingException {
		...
		String content = "<p> Hello " + users.getName() + ",</p>"
